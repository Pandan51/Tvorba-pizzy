...
<div class="page-container">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="cart_handler.php" method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="decrementQuantity">
                                    <input type="hidden" name="unique_id" value="<?php echo $id; ?>">
                                    <button class="button-round button-decrement" type="submit">-</button>
                                </form>
                                <?php echo (int)$item['quantity']; ?>
                                <form action="cart_handler.php" method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="incrementQuantity">
                                    <input type="hidden" name="unique_id" value="<?php echo $id; ?>">
                                    <button class="button-round button-increment" type="submit">+</button>
                                </form>
                            </td>
                            ...
                            <td>
                                <form action="cart_handler.php" method="POST" style="display:inline;">
                                    ...
                                    <input type="hidden" name="unique_id" value="<?php echo $id; ?>">
                                    <button class="button-decrement" type="submit">Remove</button>
                                </form>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="cart_handler.php" method="POST" style="display:inline;">
                                ...
                                <input type="hidden" name="unique_id" value="<?php echo $id; ?>">
                                <button class="button-decrement" type="submit">Clear cart</button>
                            </form>
                        </td>
                    </tr>
                </table>
    ...
    //        var_dump($_SESSION['cart']);
            ...
            <div class="flex-space-between flex-align-items-center">
                <p><a class="a-BtS" href="../pizza/index.php">Continue Shopping</a></p>
            </div>
            </div>
            <div>

                <form class="forms-grid" action="order_handler.php" method="POST" style="display:inline;">
                    ...
                    <button class="button-increment" type="submit">Confirm order</button>
