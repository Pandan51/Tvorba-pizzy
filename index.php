...
<head>
    ...
    <link rel="stylesheet" href="styles/index-style.css" media="screen">
</head>
<body>
<div class="page-container">
    <div>
        <h1>Make your own Pizza!</h1>
        <form class="forms-grid" action="cart_handler.php" method="post">
            <div class="row">
        ...
        <!--    --><?php //var_dump($_SESSION); ?>
            ...
            <button class="button-increment" type="submit">Add to Cart</button>
        </form>
    </div>
    <img class="pizza-img" src="pizza-img.png" alt="pizza-img">
</div>
</body>
</html>
